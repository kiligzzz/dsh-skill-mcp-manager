window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    const CSS =
      ...
      ".cm-switch{position:relative;width:30px;height:17px;border-radius:9px;background:var(--dsw-alias-border-l2);border:none;cursor:pointer;flex:none;padding:0}" +
      ".cm-switch.on{background:var(--dsw-alias-brand-primary)}" +
      ".cm-switch::after{content:\"\";position:absolute;top:2px;left:2px;width:13px;height:13px;border-radius:50%;background:#fff;transition:left .15s}" +
      ...
      ".cm-dot.off{background:var(--dsw-alias-border-l2)}" +
