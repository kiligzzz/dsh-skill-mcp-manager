window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    const CSS =
      ...
      ".cm-switch.on{background:var(--dsw-alias-state-business-primary)}" +
      ".cm-switch::after{content:\"\";position:absolute;top:2px;left:2px;width:13px;height:13px;border-radius:50%;background:var(--dsw-alias-label-primary);transition:left .15s}" +
