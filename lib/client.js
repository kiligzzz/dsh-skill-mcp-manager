window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    const CSS =
      ...
      ".cm-btn{background:transparent;border:1px solid var(--dsw-alias-border-inverted);color:var(--dsw-alias-label-secondary);border-radius:6px;padding:4px 10px;font-size:12px;cursor:pointer;flex:none}" +
      ".cm-btn:hover{border-color:var(--dsw-alias-brand-primary);color:var(--dsw-alias-label-primary)}" +
      ".cm-btn.primary{border-color:var(--dsw-alias-brand-primary);color:var(--dsw-alias-brand-primary)}" +
      ...
      ".cm-switch{position:relative;width:30px;height:17px;border-radius:9px;background:var(--dsw-alias-interactive-bg-hover);border:none;cursor:pointer;flex:none;padding:0;transition:background .15s}" +
      ".cm-switch.on{background:var(--dsw-alias-button-primary-fill)}" +
      ".cm-switch::after{content:\"\";position:absolute;top:2px;left:2px;width:13px;height:13px;border-radius:50%;background:var(--dsw-alias-label-primary-inverted);transition:left .15s}" +
      ".cm-switch.on::after{left:15px;background:var(--dsw-alias-label-primary-foreground)}" +
      ...
      ".cm-dot.off{background:var(--dsw-alias-label-tertiary);opacity:.5}" +
